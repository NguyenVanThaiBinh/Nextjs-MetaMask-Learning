...
// Declare type of properties
// Type in typeScript: mean interface but can use more functions like: Union, Intersection,...
...
// This type Action has 5 Actions, which merged by above type.
type Action =
  | ConnectAction
  | DisconnectAction
  | PageLoadedAction
